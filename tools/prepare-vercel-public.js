...
function validateDdmTiles() {
  ...
  assertExists(path.join(outDir, 'icons', 'waternav-192.png'), 'icons/waternav-192.png');
  assertExists(path.join(outDir, 'icons', 'waternav-512.png'), 'icons/waternav-512.png');
