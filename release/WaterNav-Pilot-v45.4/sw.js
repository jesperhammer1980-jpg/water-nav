const CACHE_NAME='waternav-v45.4';
const ASSETS=['./','./index.html?v=45.4','./style.css?v=45.4','./app.js?v=45.4','./manifest.json?v=45.4','./data/tiles/ddm-tile-manifest.json?v=45.4','./data/ddm-tile-verification.json?v=45.4','./data/ddm-verification.json?v=45.4','./data/ddm-denmark-verification.json?v=45.4'];
