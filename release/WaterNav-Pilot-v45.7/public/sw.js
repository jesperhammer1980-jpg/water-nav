const CACHE_NAME='waternav-v45.7';
const ASSETS=['./','./index.html?v=45.7','./style.css?v=45.7','./app.js?v=45.7','./manifest.json?v=45.7','./data/tiles/ddm-tile-manifest.json?v=45.7','./data/ddm-tile-verification.json?v=45.7','./data/ddm-verification.json?v=45.7','./data/ddm-denmark-verification.json?v=45.7'];
