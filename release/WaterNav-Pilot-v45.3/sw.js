const CACHE_NAME='waternav-v45.3';
const ASSETS=['./','./index.html?v=45.3','./style.css?v=45.3','./app.js?v=45.3','./manifest.json?v=45.3','./data/tiles/ddm-tile-manifest.json?v=45.3','./data/ddm-tile-verification.json?v=45.3','./data/ddm-verification.json?v=45.3','./data/ddm-denmark-verification.json?v=45.3'];
